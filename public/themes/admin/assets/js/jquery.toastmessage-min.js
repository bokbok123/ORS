(function(c){var b={inEffect:{opacity:"show"},inEffectDuration:1,stayTime:1,text:"",sticky:false,type:"notice",position:"middle-center",closeText:"",close:null};
    var a={init:function(d){if(d){c.extend(b,d)
        ...
        return c().toastmessage("showToast",d)
    },removeToast:function(e,d){e.animate({opacity:"0"},6000,function(){e.parent().animate({height:"0px"},1800,function(){e.parent().remove()
    })
    });
