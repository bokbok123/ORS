...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    **/
    createui: function()
    {
        ...
        $("<div>", { 'class': "iviewer_print iviewer_common iviewer_button", 'id':'ivwr_prnt', 'title': 'Print'})
            .bind('mousedown touchstart',function(){adminPrintReceipt(); return false;})
            .appendTo(this.container);

        $("<div>", { 'class': "iviewer_download iviewer_common iviewer_button", 'id':"ivwr_dwnld", 'title': 'Download'})
            .bind('mousedown touchstart',function(){downloadReceipt(); return false;})
            .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_in iviewer_common iviewer_button", 'title': 'Zoom In'})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_out iviewer_common iviewer_button", 'title': 'Zoom Out'})
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(this.container);
        ...
        $("<div>", { 'class': "iviewer_zoom_fit iviewer_common iviewer_button", 'title': 'Zoom Fit'})
        ...
        $("<div>", { 'class': "iviewer_rotate_left iviewer_common iviewer_button", 'title': 'Rotate Left'})
                    .bind('mousedown touchstart',function(){me.angle(-90); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_rotate_right iviewer_common iviewer_button", 'title': 'Rotate Right'})
                    .bind('mousedown touchstart',function(){me.angle(90); return false;})
                    .appendTo(this.container);
...
function adminPrintReceipt(){

    if($('img#imagefullbillview').hasClass('noAttachment')){

    }else if($('.iviewer_cursor').hasClass('imgPlace') || $('#adminImgPlace').length){
        ...
        printWindow.document.write("<img id='img' src='" + source + "'/>");
...
function downloadReceipt(){
        var source = $('#adminImgPlace img').attr('src');
        window.location = "downloadReceipt?source="+source;
}

function adminPrintReceipt2(source){
...
function downloadReceipt2(source){
    window.location = "downloadReceipt?source="+source;
}